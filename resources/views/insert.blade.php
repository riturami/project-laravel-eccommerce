...
<form method="post" enctype="multipart/form-data" action="hy">
@csrf
...
<div class="mb-3 mt-3">
  ...
  <div class="mb-3">
    ...
    <input type="file" class="form-control"  placeholder="select image" name="img">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <select placeholder="select category" name="cate" style="width: 20%">
